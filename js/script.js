...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 37.5330399, lng: -122.2851249, zoom: 13, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 37.5330399, lng: -122.2851249, title: 'Matthew Childs',
      infoWindow: { content: '<p>Home</p>' } });
